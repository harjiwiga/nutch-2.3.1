...
public class WebPage extends org.apache.gora.persistency.impl.PersistentBase implements org.apache.avro.specific.SpecificRecord, org.apache.gora.persistency.Persistent {
  ...
  public void put(int field$, Object value) {
    ...
    case 24: batchId = (CharSequence)(value); break;
      case 25: readable = (CharSequence)(value); break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public void setReadable(CharSequence value) {
    this.readable=value;
    setDirty(25);
  }

  public boolean isReadableDirty(CharSequence value) {
    return isDirty(25);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<WebPage>
    ...
    private Builder(WebPage other) {
      ...
      if (isValidValue(fields()[25], other.readable)) {
        this.readable = (CharSequence) data().deepCopy(fields()[25].schema(), other.readable);
    ...
    /** Gets the value of the 'readable' field */
    public CharSequence getReadable() {
      return batchId;
    }

    /** Sets the value of the 'batchId' field */
    public Builder setReadable(CharSequence value) {
    ...
    public WebPage build() {
      try {
        ...
        record.readable = fieldSetFlags()[5] ? this.readable : (CharSequence) defaultValue(fields()[25]);
        return record;
      } catch (Exception e) {
