...
public class StoreReadable extends HtmlParser {
    ...
    private static String sniffCharacterEncoding(ByteBuffer content) {
        System.out.println("[STORE-READABLE]sniffCharacterEncoding----------------------------------------------------------");
...
//        storeJsonToSchema(url, page ,strJo);
    ...
    private String addJsonToPage(String url, WebPage page) {
        ...
        Content r = new Content(url, url, page.getContent().array(), page.getContentType().toString(), metaData, conf);
...
//        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStore<String, WebPage> store = StorageUtilsPlugin.createWebStore(localConf,
                String.class, WebPage.class, schemaPrefix);
